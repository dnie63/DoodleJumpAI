public class NEAT_Config {
    ...
    public static final int INPUTS = 50 * 80;
    ...
    public static final float PERTURB_CHANCE = 0.5f;
    public static final float WEIGHT_CHANCE = 0.75f;
    public static final float WEIGHT_MUTATION_CHANCE = 0.95f;
    public static final float NODE_MUTATION_CHANCE = 0.5f;
    public static final float CONNECTION_MUTATION_CHANCE = 0.5f;
    public static final float BIAS_CONNECTION_MUTATION_CHANCE = 0.5f;
    public static final float DISABLE_MUTATION_CHANCE = 0.2f;
    ...
    public static final float WEIGHT_CHANCE = 0.4f;
    public static final float WEIGHT_MUTATION_CHANCE = 0.95f;
    ...
    public static final float ENABLE_MUTATION_CHANCE = 0.2f ;
    public static final float CROSSOVER_CHANCE = 0.8f;*/
